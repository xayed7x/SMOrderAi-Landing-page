      ...
      <div className="self-stretch h-auto flex flex-col md:flex-row justify-between items-stretch pr-0 pb-8 pt-0">
        <div className="h-auto p-4 md:p-8 flex flex-col justify-start items-start gap-8">
          ...
          <div className="flex justify-start items-start gap-4">
            ...
            {/* WhatsApp Icon */}
            <a href="https://wa.me/8801977994057" target="_blank" rel="noopener noreferrer" className="w-6 h-6 relative overflow-hidden cursor-pointer hover:opacity-70">
        ...
        <div className="self-stretch p-4 md:p-8 grid grid-cols-2 sm:grid-cols-4 gap-8">
          ...
          <div className="flex flex-col justify-start items-start gap-3">
            ...
            <div className="flex flex-col justify-center items-start gap-2">
              ...
              <a href="https://wa.me/8801977994057" target="_blank" rel="noopener noreferrer" className="text-[#49423D] text-sm font-normal leading-5 font-sans cursor-pointer hover:text-[#37322F] transition-colors">
                WhatsApp
              </a>
            </div>
          </div>
